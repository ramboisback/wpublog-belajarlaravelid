...
<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <input name="avatar" class="@error('avatar') border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500 @enderror block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="avatar_help" id="avatar" type="file" accept="image/png, image/jpeg, image/jpg">
            {{-- <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="avatar_help">A profile picture is useful to confirm your are logged into your account (*.png or *.jpg)</div> --}}
            <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="avatar_help">Avatar's (*.png or *.jpg)</div>
            @error('avatar')    
...
@push('scriptsfilepond')
    ...
    <script>
        ...
        const pond = FilePond.create(inputElement, {
            ...
            // labelIdle: 'Drag & Drop file anda or <span class="filepond--label-action">Browse</span>',
