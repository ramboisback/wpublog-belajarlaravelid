    ...
    <footer class="bg-gray-50 dark:bg-gray-800 antialiased">
        <div class="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:p-10">
            <div class="text-center">
                ...
                <span class="block text-sm text-center text-gray-500 dark:text-gray-400">© 2025 <a href="https://codeqiu.id" class="hover:underline">Codeqiu™</a>. All Rights Reserved.
                </span>
                <ul class="flex justify-center mt-5 space-x-5 mb-5">
                    <li>
